#!/bin/sh
# Purpose: map of coastal shoreline with grid crosses, Albers equal−area conic projection (here: Kuril-Kamchatka Trench)
# GMT modules: pscoast
gmt pscoast -R140/170/40/60 -JB155/50/45/55/6i -P -Ba \
